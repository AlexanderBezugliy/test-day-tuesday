            ...
            <div class="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
                ...
                <div>
                    ...
                    <ul class="mt-2 space-y-2">
                        ...
                        <li><a href="/" class="hover:text-gray-200 transition">Support</a></li>
                        <li><a href="/" class="hover:text-gray-200 transition">Pricing</a></li>
                        <li><a href="/" class="hover:text-gray-200 transition">Affiliate</a></li>
                    </ul>
                </div>
                <div>
                    <p class="text-slate-100 font-semibold">Resources</p>
                    <ul class="mt-2 space-y-2">
                        <li><a href="/" class="hover:text-gray-200 transition">Company</a></li>
                        <li><a href="/" class="hover:text-gray-200 transition">Blogs</a></li>
                        <li><a href="/" class="hover:text-gray-200 transition">Community</a></li>
                        <li><a href="/" class="hover:text-gray-200 transition">Careers<span class="text-xs text-white bg-gray-600 rounded-md ml-2 px-2 py-1">We’re hiring!</span></a></li>
                ...
                <div>
                    ...
                    <ul class="mt-2 space-y-2">
                        <li><a href="/" class="hover:text-gray-200 transition">Privacy</a></li>
                        <li><a href="/" class="hover:text-gray-200 transition">Terms</a></li>
                    </ul>
                </div>
            </div>

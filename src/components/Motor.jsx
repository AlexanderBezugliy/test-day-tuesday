...
const Motor = () => {
    return (
        <div className='w-full pt-5 bg-[#0C0D0D] text-white'>
            <div className='mx-auto max-w-[1440px] px-5 gap-x-20  flex flex-col motor-md:flex-row'>
                {/* left */}
                ...
                <div className='flex-[70%] flex flex-col items-center motor-md:block'>
                    ...
                    <div className='flex flex-col motor-xl:flex-row justify-between gap-10 motor-md:gap-[7px] motor-xl:gap-[45px] pb-28'>
